      ...
      <html>
        <body>
          <form action="/ors" method="get">
		    <center><h3> ORS for Visually Impaired(Simple Prototype) - <sup>powered by Google App Engine</sup> </h3></center>
            <div>
			<center>
			<b>Source</b> (Street, City, Country) :<input type="text" name="source">
            <b>Destination</b> (Street, City, Country) :<input type="text" name="desti">
			</center>
			<br>
...
class Orsroute(webapp.RequestHandler):
    def get(self):
        ...
        self.response.out.write('<html><body>Routing Information is:<pre>')
